    ...
    public partial class OsuSliderVelocityToolboxGroup : EditorToolboxGroup
    {
        ...
        protected override void LoadComplete()
        {
            ...
            sliderControl.Current.BindValueChanged(_ =>
            {
                ...
                // basically if the slider velocity source is valid,
                // then this chagne to `sliderControl.Current` did not originate from the giant revalidation block in `Update()`,

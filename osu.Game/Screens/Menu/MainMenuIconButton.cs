...
namespace osu.Game.Screens.Menu
{
    public partial class MainMenuIconButton : MainMenuButton
    {
        ...
        public MainMenuIconButton(LocalisableString text, string sampleName, IconUsage symbol, Color4 colour, Action<MainMenuButton>? clickAction = null, params Key[] triggerKeys)

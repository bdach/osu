...
{
    public partial class DailyChallengeResultsScreen : OnlinePlayResultsScreen
    {
        private readonly long scoreId;

        public DailyChallengeResultsScreen(long roomId, PlaylistItem playlistItem, long scoreId)

    ...
    public partial class ParticipantPanel : PoolableDrawable, IHasContextMenu, IHasCurrentValue<MultiplayerRoomUser>
    {
        ...
        public MenuItem[]? ContextMenuItems
        {
            get
            {
                ...
                // If the local user is not the host of the room or a referee in it.
                if (client.Room.Host?.UserID != api.LocalUser.Value.Id && user.Role != MultiplayerRoomUserRole.Referee)
                    return null;

...
{
    public abstract partial class OnlinePlayResultsScreen : ResultsScreen
    {
        ...
        protected OnlinePlayResultsScreen(ScoreInfo? score, long roomId, PlaylistItem playlistItem)
            : base(score)
        {
            RoomId = roomId;
        ...
        private APIRequest createIndexRequest(Action<IEnumerable<ScoreInfo>> scoresCallback, MultiplayerScores? pivot = null)
        {
            ...
            indexReq.Success += r =>
            {
                ...
                Schedule(() => PerformSuccessCallback(scoresCallback, r.Scores, r));
            };
        ...
        protected void HideLoadingSpinners(MultiplayerScores? pivot = null)
        {
            CentreSpinner.Hide();

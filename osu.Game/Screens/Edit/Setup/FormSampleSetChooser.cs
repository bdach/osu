...
namespace osu.Game.Screens.Edit.Setup
{
    public partial class FormSampleSetChooser : FormDropdown<EditorBeatmapSkin.SampleSet?>, IHasPopover
    {
        ...
        private void populateItems()
        {
            ...
            items.Insert(0, new EditorBeatmapSkin.SampleSet(-1, "Add new..."));
            Items = items;
        }
        ...
        public Popover GetPopover() => new NewSampleSetPopover(
            Items.Any() ? Items.Max(i => i?.SampleSetIndex ?? 0) : 0,
            idx =>
            {
                if (idx == null)
                {
                ...
                Items = Items.Append(sampleSet).OrderBy(s => s?.SampleSetIndex).ToList();
        ...
        private partial class NewSampleSetPopover : OsuPopover
        {
            ...
            public override void Hide()
            {
                if (State.Value == Visibility.Visible)
                    onCommit.Invoke(committedIndex);
                base.Hide();
            }
        }
    }

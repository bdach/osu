...
namespace osu.Game.Screens.SelectV2
{
    public partial class BeatmapMetadataWedge : VisibilityContainer
    {
        ...
        [Resolved]
        private BeatmapSetLookupCache beatmapSetCache { get; set; } = null!;
        ...
        private void refetchBeatmapSet()
        {
            ...
            if (beatmapSetInfo.OnlineID >= 1)
            {
                ...
                currentFetchTask = beatmapSetCache.GetAsync(beatmapSetInfo.OnlineID);
        ...
        private void updateUserTags()
        {
            ...
            userTags.Tags = (tags, t => songSelect?.Search(t));
        }
    }
}
